...
class LinkedListTest < Test::Unit::TestCase
  ...
  def test_15b_find_first_item
   ...
   def test_15c_index_of_middle_item
    ll = LinkedList.new()
    ll.add_item("foo")
    ll.add_item("bar")
    ll.add_item("good")
   ...
   def test_15d_index_of_last_item
    ll = LinkedList.new()
    ll.add_item("foo")
    ll.add_item("bar")
    ll.add_item("good")
  ...
  def test_15e_index_of_missing_item
    ll = LinkedList.new()
    ll.add_item("foo")
    ll.add_item("bar")
    ll.add_item("good")
  ...
  def test_15f_index_of_duplicate
    ll = LinkedList.new()
    ll.add_item("foo")
    ll.add_item("bar")
    ll.add_item("good")
    ll.add_item("foo")
    assert_equal([0, 3], ll.index("foo"))
  end
  
  def test_15m_test_of_comparison
    ll = LinkedList.new()
    lli = ll.add_item("foo")
    ll.add_item("bar")
